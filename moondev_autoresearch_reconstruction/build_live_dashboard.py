...
"## Search progress",
"",
f"**{breadth_pct:.2f}% of breadth candidate budget**  ",
f"`{bar(valid,breadth_total)}`  **{valid:,} / {breadth_total:,} valid candidates**",
"",
f"- Runnable tracks: **{runnable:,}**",
f"- Tracks touched: **{touched:,}**",
f"- Tracks with ≥1 valid candidate: **{v1:,}**",
f"- Tracks with ≥2 valid candidates: **{v2:,}**",
f"- Tracks breadth-complete (≥10 valid): **{v10:,}**",
