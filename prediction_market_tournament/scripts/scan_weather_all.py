...
def is_temperature_event(
    ...
    return (
        ...
        in title
        or "lowest temperature in "
        in title
    )


def existing_weather_markets(
    ledger_path: Path,
) -> set[str]:
    seen: set[str] = set()
